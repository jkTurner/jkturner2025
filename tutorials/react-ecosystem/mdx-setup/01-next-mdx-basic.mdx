---
title: "Next-MDX Basic Setup"
metaTitle: "How to Set Up MDX in Next.js 15 with Pretty Code Highlighting"
description: "A full walkthrough of integrating next-mdx, rehype-pretty-code, Shiki, and Tailwind typography in Next.js 15.3.3"
date: "2025-05-30"
...
<CodeBlock header="Install next-mdx dependencies">
```tsx
npm install @next/mdx @mdx-js/loader @mdx-js/react @types/mdx
```
</CodeBlock>

<CodeBlock header="Install rehype-pretty-code & shiki">
```tsx
npm install rehype-pretty-code shiki
```
</CodeBlock>

<CodeBlock header="Install remark-gfm">
```tsx
npm install remark-gfm
```
</CodeBlock>

<CodeBlock header="Install tailwindcss-typography">
```tsx
...
<CodeBlock 
  header="Add the Tailwind Typography plugin to your global CSS:" 
  title="root/app/global.css">
```tsx
@import "tailwindcss";
